...
const CheckOutPage = () => {
  ...
  const onSubmit = async (data) => {
    try {
      const res = await checkListService.createCheckOut({
        ...data,
        staffId: staffId,
        staffEmail: email,
        rentalId: id
  ...
  return (
    <div className='space-y-6'>
      ...
      <div>
        ...
        <p className='text-muted-foreground'>Hoàn thành quy trình trả xe cho đơn thuê #{id}</p>
      </div>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input {...field} placeholder='TRẢ XE' readOnly className='bg-gray-50' />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
